...
let test = array4.length - 2;
// console.log("test value is" + test)
console.log("second to last item in array  " + array4[test]);
console.log("second to last item in array  " + array4[array4.length - 2]);
/*
 * Prompt 11:
 *
...
// console.log("Remove Thom from the thom array and replace it with Gameboy");
thom[0] = 'Gameboy';
console.log(thom[0]);
